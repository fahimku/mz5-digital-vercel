...
export function Footer() {
  return (
    <footer className="relative z-10 border-t border-white/[0.06] bg-[#050505]/95 py-12 sm:py-16 backdrop-blur-sm">
      <Container>
        <div className="grid grid-cols-2 gap-x-6 gap-y-10 sm:gap-y-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="col-span-2 lg:col-span-3 lg:text-right">
            <h4 className="mb-4 text-sm font-semibold text-white">
              Let&apos;s connect
            </h4>
            <div className="flex gap-3 sm:gap-3 lg:justify-end">
            ...
            <a
              ...
              className="mt-4 inline-block text-sm text-muted transition hover:text-[#ff4d00] lg:mt-5"
            >
              {siteConfig.email}
            </a>
          </div>
